    ...
    <article className="group flex h-full min-h-[336px] flex-col overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm transition-[border-color,box-shadow,transform] duration-150 active:scale-[0.995] sm:hover:-translate-y-0.5 sm:hover:border-emerald-200 sm:hover:shadow-soft">
      <div className="relative aspect-[5/4] overflow-hidden bg-slate-50">
        ...
        <button
          ...
          className={cn(
            "absolute right-2 top-2 grid h-10 w-10 place-items-center rounded-full border border-white/80 bg-white text-slate-600 shadow-sm transition active:scale-95",
      ...
      <div className="flex flex-1 flex-col p-3">
        <div className="min-h-[86px]">
          <div className="flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-normal text-slate-500">
          ...
          <Link
            ...
            className="mt-1 line-clamp-2 min-h-10 text-[15px] font-black leading-5 text-slate-950 transition hover:text-emerald-800"
          >
            {displayName}
          </Link>
        ...
        <div className="mt-2 grid min-h-10 grid-cols-[1fr_auto] items-center gap-2">
          ...
          <div className="text-right">
            <p className="text-[11px] font-bold uppercase text-slate-400">{selectedUnit}</p>
            <p className="text-lg font-black leading-5 text-emerald-800">{formatCurrency(unitPrice)}</p>
          </div>
        </div>
        ...
        <div className="mt-3 grid h-12 grid-cols-[1fr_auto] items-center gap-2 border-t border-slate-100 pt-3">
          ...
          {cartQuantity > 0 ? (
            ...
            >
              ...
              <span className="grid place-items-center border-x border-white/20 text-sm font-black tabular-nums">{cartQuantity}</span>
