...
export function PwaRegister() {
  ...
  return (
    <>
      {showUpdatePrompt ? (
        <div className="fixed bottom-4 left-4 right-4 z-[80] rounded-lg border border-slate-200 bg-white p-4 shadow-soft sm:left-auto sm:w-96">
      ...
      {showInstallPrompt && installPrompt ? (
        <div className="fixed bottom-4 left-4 right-4 z-[75] rounded-lg border border-slate-200 bg-white p-4 shadow-soft sm:left-auto sm:w-96">
          <div className="flex items-start justify-between gap-3">
            <div>
